...
#   <Anthony Cabral--11/27/2024--Created Script-------------------------------------------------------------------- #
...
class Person:
    def __init_(self, first_name, last_name):
        """This class creates the person class,
        for defining names, easy formatting,
    ...
    def first_name(self):
        return self.__first_name_str.title()
    ...
    @property  # (getter or accessor)
    def last_name(self):
        return self.__last_name_str.title()
...
class Student(Person):
    """This class creates the Student class,
            which inherits from the Person class,
             and allows easy formatting
            """
    ...
    def course_name(self):
        return self.__course_name_str.title()
    ...
    def course_name(self, value: str):
        if value.isalpha():
            ...
            raise ValueError("Course name must be alphabetic")

    def __str__(self):
        return
        f"Student: {self.first_name} {self.last_name} is in {self.course_name}"
